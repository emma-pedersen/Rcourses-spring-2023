...
- `pivot_wider()`: Trnasformere dit data til **Wider** format
- `pivot_longer()`: Trnasformere dit data til **Longer** format
...
Et data format oftests brugt af fx. OECD, inkluderer flere variable i en kolonne, og kaldes **longer**.
...
Det data format i nok har set mest ind til videre er **Wider** formatet, en variabel per kolonne.
